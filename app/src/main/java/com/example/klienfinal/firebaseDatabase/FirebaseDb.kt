package com.example.klienfinal.firebaseDatabase
...
import com.example.klienfinal.util.Constants.Companion.ADDRESS_COLLECTION
import com.example.klienfinal.util.Constants.Companion.BEST_DEALS
import com.example.klienfinal.util.Constants.Companion.CART_COLLECTION
import com.example.klienfinal.util.Constants.Companion.CATEGORIES_COLLECTION
import com.example.klienfinal.util.Constants.Companion.CATEGORY
import com.example.klienfinal.util.Constants.Companion.CLOTHES
import com.example.klienfinal.util.Constants.Companion.COLOR
import com.example.klienfinal.util.Constants.Companion.CUPBOARD_CATEGORY
import com.example.klienfinal.util.Constants.Companion.ID
import com.example.klienfinal.util.Constants.Companion.ORDERS
import com.example.klienfinal.util.Constants.Companion.ORDER_PLACED_STATE
import com.example.klienfinal.util.Constants.Companion.PRICE
import com.example.klienfinal.util.Constants.Companion.PRODUCTS_COLLECTION
import com.example.klienfinal.util.Constants.Companion.QUANTITY
import com.example.klienfinal.util.Constants.Companion.SIZE
import com.example.klienfinal.util.Constants.Companion.STORES_COLLECTION
import com.example.klienfinal.util.Constants.Companion.TITLE
import com.example.klienfinal.util.Constants.Companion.USERS_COLLECTION
